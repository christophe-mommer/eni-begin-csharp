...
void JouerJeu(int borneMaximum, int nbEssais)
{
    string saisie = "";
...
void VerifierScorePourPalmares(int borneMaximum, int nbEssais, int tentatives)
{
...
void AddPlayerScore(int playerScore)
{
